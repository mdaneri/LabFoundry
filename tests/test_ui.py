...
def test_pwa_manifest_service_worker_and_offline_shell(client):
    ...
    assert "labfoundry-pwa-v160" in service_worker.text
    ...
    assert "/static/app.css?v=appliance-update-source-layout-20260724-1" in service_worker.text
    assert "/static/app.js?v=appliance-update-source-layout-20260724-1" in service_worker.text
    ...
    assert "/static/app.css?v=appliance-update-source-layout-20260724-1" in offline.text
...
def test_monitor_page_renders_and_data_endpoint(client):
    ...
    assert "/static/app.css?v=appliance-update-source-layout-20260724-1" in page.text
    assert "/static/app.js?v=appliance-update-source-layout-20260724-1" in page.text
...
def test_firewall_settings_autosave_updates_desired_state_preview(client):
    ...
    assert "appliance-update-source-layout-20260724-1" in page.text
