...
class DhcpSettings(Base):
    ...
    range_start: Mapped[str] = mapped_column(String(64), default="")
    range_end: Mapped[str] = mapped_column(String(64), default="")
...
class KmsSettings(Base):
    ...
    listen_interface: Mapped[str] = mapped_column(String(80), default="")
    listen_address: Mapped[str] = mapped_column(String(64), default="")
