...
Task detail modals render redacted result payloads as wrapped, syntax-highlighted JSON previews and task output as highlighted log previews. Both previews remain inside the viewport and expose a copy action without presenting read-only content as a form control.
