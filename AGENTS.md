...
- Appliance Settings owns appliance FQDN, OS hostname, appliance resolver mode/servers, and the appliance NTP client. DNS/DHCP owns rendered DNS records and dnsmasq reload, not appliance resolver or hostname enforcement.
