...
& $resolvedVmrun -T ws reset $resolvedVmxPath $Mode
if ($LASTEXITCODE -ne 0) {
    throw "vmrun reset failed with exit code $LASTEXITCODE."
}
Write-Host "Reset VMware Workstation VM: $resolvedVmxPath"
