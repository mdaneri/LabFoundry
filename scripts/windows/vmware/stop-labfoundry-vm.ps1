...
& $resolvedVmrun -T ws stop $resolvedVmxPath $Mode
if ($LASTEXITCODE -ne 0) {
    throw "vmrun stop failed with exit code $LASTEXITCODE."
}
Write-Host "Stopped VMware Workstation VM: $resolvedVmxPath"
